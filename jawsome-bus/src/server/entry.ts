...
import { POST as bookingCheckoutPOST } from "./api/booking/checkout/POST";
import bookingVerifyGet from "./api/booking/verify/GET";
import { POST as stripeWebhookPOST } from "./api/stripe/webhook/POST";
import adminEventsPost from "./api/admin/events/POST";
import contactPost from "./api/contact/POST";
import adminOrdersGet from "./api/admin/orders/GET";
import accountOrdersGet from "./api/account/orders/GET";
// </api-imports>
import { seoRoutes } from "../lib/seo-routes"; 
import storeCheckoutPost from "./api/store/checkout/POST";
...
app.post("/api/booking/checkout", bookingCheckoutPOST);
app.post("/api/store/checkout", storeCheckoutPost);
app.post("/api/stripe/webhook", stripeWebhookPOST);
app.get("/api/booking/verify", bookingVerifyGet);
app.post("/api/contact", contactPost);
app.post("/api/admin/events", adminEventsPost);
app.get("/api/admin/orders", adminOrdersGet);
app.get("/api/account/orders", accountOrdersGet);
// </api-registrations>
